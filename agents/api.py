"""
FastAPI REST API Server for Paracetamol Rumack Matthew Nomogram.
"""
...
app = FastAPI(
    title="Paracetamol Rumack Matthew Nomogram API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "paracetamol-rumack-matthew-nomogram", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
